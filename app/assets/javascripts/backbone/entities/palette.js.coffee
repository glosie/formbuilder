  ...
  API =
    getPalette: ->
      new Entities.Palette [
        ...
        { name: "Single Selection", component_type: "select", icon: "icon-collapse", options: "Option 1,Option 2,Option 3" }
        { name: "Multiple Selection", component_type: "multipleselect", icon: "icon-reorder", options: "Option 1,Option 2,Option 3" }
        { name: "Checkbox", component_type: "checkbox", icon: "icon-check", options: "Checkbox 1,Checkbox 2,Checkbox 3" }
        { name: "Radio Buttons", component_type: "radio", icon: "icon-circle-blank", options: "Option 1,Option 2,Option 3" }
      ]
